...
public class OpenedTournamentPanel extends JPanel {
    ...
    public static void main(String[] args) {
		...
		classesLvl2.put("Prof Avec un super long nom", new String[]{ "Valentin", "Vaea", "Thomas", "Manon", "Lucas", "Jeanne", "Juliette", "Romane", "Agnese", "Pauline",
		...
		classesLvl3.put("Prof Avec un super long nom", new String[]{"Milane", "Nathan", "Adrien", "Léna", "Abdellah"});
